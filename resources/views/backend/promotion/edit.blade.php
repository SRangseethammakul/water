        ...
        @method('PUT')
            ...
            <div class="form-group">
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="promotion_status_1" value="1" name="promotion_status" class="custom-control-input" {{ ($promotion->promotion_status=="1")? "checked" : "" }}>
                    <label class="custom-control-label" for="promotion_status_1">ใช้งาน</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="promotion_status_2" value="0" name="promotion_status" class="custom-control-input" {{ ($promotion->promotion_status=="0")? "checked" : "" }}>
